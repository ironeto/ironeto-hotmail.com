...
namespace CNAB240BB.ReturnFile
{
    public class CNAB240ReturnFileHeaderLote
    {
        ...
        public string CNABDadosServico{ get; set; } // Uso exclusivo da FEBRABAN 17 17 1 - Brancos
        ...
        public string ComplementoLogradouro { get; set; } //Caso, Apto, Sala, etc 178 192 18 - Alfanumérico
        ...
        public string CNABDadosEmpresa { get; set; } //Uso exclusivo da FEBRABAN 223 230 8 - Brancos
