...
namespace CNAB240BB.ReturnFile
{
    public class CNAB240ReturnFileTrailerLote
    {
        ...
        //Dados de Arquivo
        public int QtdeRegistros { get; set; } //Quantidade de registros do lote 18 23 6 - Numérico(Reg. 1+3+5)
        public decimal Valor { get; set; } //Somatória dos valores 24 41 16 2 Numérico(Reg.Tipos 3)
        public decimal QtdeMoedas { get; set; } //Somatória de quantidade moedas 42 59 13 5 '000000000000000000'
        public string NrAviso { get; set; } //Número aviso débito 60 65 6 - '000000'
        public string CNABDadosArquivo { get; set; } //Uso exclusivo FEBRABAN 66 230 165 - Brancos
